...
// TODO: FILTER FAVORITE AUTHORS - FIXED
const favoriteAuthors = (uid) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/authors.json?orderBy="favorite"&equalTo=true&uid="${uid}`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
// TODO: GET A SINGLE AUTHOR'S BOOKS - DONE
